...
-- ----------------------------
INSERT INTO `app_categories` VALUES (2, 'Chính trị', '1761807273382-quochuy.jpg', b'1', 2, NULL, NULL, '2025-10-30 06:54:46.587517', 'admin@gmail.com', 11, 1, 'https://bacninh.gov.vn/chinh-tri');
INSERT INTO `app_categories` VALUES (3, 'Kinh tế', '1761807309187-bacninh.jpg', b'1', 3, NULL, NULL, '2025-10-30 06:55:21.920313', 'admin@gmail.com', 11, 1, 'https://bacninh.gov.vn/kinh-te');
INSERT INTO `app_categories` VALUES (4, 'Tin mới nhất', '1760364460683-1716687768336-apple.jpg', b'1', 1, '2025-10-13 14:07:44.000000', 'admin@gmail.com', '2025-10-30 06:53:54.280215', 'admin@gmail.com', 11, 2, 'https://bacninh.gov.vn/trang-chu');
INSERT INTO `app_categories` VALUES (5, 'Văn hóa', '1761807342399-quochuy.jpg', b'1', 4, '2025-10-30 06:55:52.637093', 'admin@gmail.com', NULL, NULL, 11, 1, 'https://bacninh.gov.vn/van-hoa');
INSERT INTO `app_categories` VALUES (6, 'Xã hội', '1761807377739-quochuy.jpg', b'1', 5, '2025-10-30 06:56:32.528763', 'admin@gmail.com', NULL, NULL, 11, 1, 'https://bacninh.gov.vn/xa-hoi');
INSERT INTO `app_categories` VALUES (7, 'Sở, ngành, địa phương', '1761807438664-quochuy.jpg', b'1', 6, '2025-10-30 06:57:19.694547', 'admin@gmail.com', NULL, NULL, 11, 1, 'https://bacninh.gov.vn/so-nganh-dia-phuong');
INSERT INTO `app_categories` VALUES (8, 'Tin trong nước', '1761807520402-quochuy.jpg', b'1', 7, '2025-10-30 06:58:41.541998', 'admin@gmail.com', NULL, NULL, 11, 1, 'https://bacninh.gov.vn/tin-trong-nuoc');
INSERT INTO `app_categories` VALUES (9, 'Tin quốc tế', '1761807561158-quochuy.jpg', b'1', 8, '2025-10-30 06:59:23.075871', 'admin@gmail.com', NULL, NULL, 11, 1, 'https://bacninh.gov.vn/tin-quoc-te');
...
CREATE TABLE `article_sync`  (
  ...
  `urlArticle` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `urlImage` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `publishDate` datetime(0) NULL DEFAULT NULL,
  `createDate` datetime(0) NULL DEFAULT NULL,
  `summary` varchar(2048) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `author` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `source` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_url_article`(`urlArticle`(768)) USING BTREE
